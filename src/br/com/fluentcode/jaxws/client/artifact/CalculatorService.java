 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://service.jaxws.fluentcode.com.br/", wsdlLocation = "http://localhost:8080/JAXWS-Example/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://service.jaxws.fluentcode.com.br/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/JAXWS-Example/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://service.jaxws.fluentcode.com.br/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.jaxws.fluentcode.com.br/", "CalculatorPort"), Calculator.class, features);
    }
